            ...
            <div className="row">
                <div className="col-md-7 mrgnbtm">
                    ...
                    <form>
                        ...
                        <button type="button" onClick={(e) => apiGetFiles()} className="btn btn-danger">Get file</button>
                        <button type="button" onClick={(e) => apiSetFiles()} className="btn btn-danger">Set file</button>
                    </form>
                </div>
            </div>
        </div>
